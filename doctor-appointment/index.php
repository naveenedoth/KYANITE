...
?>
		      	<div class="card">
		      		<form method="post" action="result.php">
			      		<div class="card-header text-danger"><h3><b>Doctor Schedule List</b></h3></div>
			      		<div class="card-body">
		      					...
		      					<table class="table table-striped table-bordered">
		      						...
		      						foreach($result as $row)
		      						{
		      							...
		      							<tr>
		      								...
		      								<td><button type="button" name="get_appointment" class="btn btn-dark btn-sm get_appointment" data-id="'.$row["doctor_schedule_id"].'">Get Appointment</button></td>
		      							</tr>
		      							';
		      						}
		      						?>
